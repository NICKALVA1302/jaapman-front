...
import { ViewUsuarioComponent } from '../../../presidente/materiales/components/view-usuario/view-usuario.component';
...
export class MultaComponent {
  ...
  irEditar() {
    this.router.navigate(['//presidente/materiales/listMulta']);
  }
