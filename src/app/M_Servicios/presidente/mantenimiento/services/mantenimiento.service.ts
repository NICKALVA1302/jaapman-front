...
import { DatosPorLocalidad, Localidad } from '../../materiales/models/localidades';
import { Material } from '../../materiales/models/material';
...
export class MantenimientoService {
  ...
  postAgregarMantenimiento(id_usuario: number, id_tarifa: number | null, id_estado_pago: number, materiales: any[]): Observable<any> {
    // Asignar un valor predeterminado si id_tarifa es null
    const idTarifa = id_tarifa ?? null;

    const body = { id_usuario, id_tarifa: idTarifa, id_estado_pago, materiales };
    return this.http.post<any>(`${this.myAppUrl}${this.myApiUrlPresi}/agregarMantenimiento`, body);
  }
